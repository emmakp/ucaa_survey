                ...
                <div class="container p-4">
                                    ...
                                    <div class="col">
                                        @if ($user[0]->validity === 0)
                                            ...
                                            <form action="{{route('unblock_user', ['staff' => $user[0]->Obfuscator, 'firstname' => $user[0]->FirstName, 'lastname' => $user[0]->SecondName,])}}" method="post">
                                                ...
                                                <input type="submit" value="Unblock User" class="btn btn-danger">
                                            </form>
                                        ...
                                        @else
                                            ...
                                            <form action="{{route('block_user', ['staff' => $user[0]->Obfuscator, 'firstname' => $user[0]->FirstName, 'lastname' => $user[0]->SecondName,])}}" method="post">
                                                ...
                                                <input type="submit" value="Block User" class="btn btn-danger">
                                            </form>
                                        @endif
                                    </div>
                                @endif
                    ...
                    <div class="row mt-5">
                        <div class="col-6">
                            ...
                            <p>Second Name: {{$user[0]->SecondName}}</p>
                            <p>User Name: {{$user[0]->username}}</p>
                            <p>Status: {{$user[0]->validity}}</p>
                        </div>
                        <div class="col-6">
                            <p>Email: {{$user[0]->email}}</p>
                            <p>Gender: {{$user[0]->gender}}</p>
                            <p>User Role: {{$user[0]->user_role->RoleName}}</p>
                            <br>
