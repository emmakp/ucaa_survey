...
<link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=3.3.55620&themeRevisionID=65660e4b326633110492e01a"/>
...
<script src="https://cdn02.jotfor.ms/static/prototype.forms.js?v=3.3.55620" type="text/javascript"></script>
<script src="https://cdn03.jotfor.ms/static/jotform.forms.js?v=3.3.55620" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/s/umd/6b492ba38cf/for-widgets-server.js?v=3.3.55620" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/s/umd/6b492ba38cf/for-appointment-field.js?v=3.3.55620" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/js/vendor/smoothscroll.min.js?v=3.3.55620" type="text/javascript"></script>
<script src="https://cdn02.jotfor.ms/js/errorNavigation.js?v=3.3.55620" type="text/javascript"></script>
<script type="text/javascript">
    ...
    JotForm.init(function () {
        ...
        $("input_26").rating({ stars: "5", inputClassName: "form-textbox", imagePath: "https://cdn.jotfor.ms/images/stars_v2.png", cleanFirst: true, value: "" });
        $("input_26").setAttribute("role", "radiogroup");
        $("input_26").setAttribute("aria-labelledby", "label_26");

        Array.from($("input_26").children).map(function (e, i) {
...
<body>
<form class="jotform-form" action="{{ route('guest.form.post', ['survey_id' => $questionaire->survey->obfuscator, 'questionaire_id' => $questionaire->obfuscator]) }}" method="post" accept-charset="utf-8" autocomplete="on">
    @csrf
    <div role="main" class="form-all">
        ...
        <li id="cid_17" class="form-input-wide" data-type="control_head">
            ...
            <div class="header-text httac htvam">
                <h1 id="header_17" class="form-header" data-component="header">UCAA Survey</h1>
                <div id="subHeader_17" class="form-subHeader">Please fill in the information</div>
            </div>
            </div>
        </li>
    ...
    <script>
        JotForm.poweredByText = "Powered by NAJOD";
    </script>
    <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="242097293840562" />
    <script type="text/javascript">
